...
-- Example: Assign all permissions to user with ID 1 (Naruto)
INSERT INTO user_permissions (user_id, permission_id)
SELECT 1, id FROM permissions;

-- Example: Assign only CAN_SEARCH_ORDER and CAN_TRACK_ORDER to user with ID 2 (Sasuke)
INSERT INTO user_permissions (user_id, permission_id)
SELECT 2, id FROM permissions WHERE name IN ('CAN_SEARCH_ORDER', 'CAN_TRACK_ORDER');
